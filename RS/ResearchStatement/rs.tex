...
%I am interested in building practical and reliable networked embedded systems and inference algorithms for modern cyber-physical systems (CPS). 
%With regard to sensing and estimation, the challenge in modern CPS from a practical perspective is that we have to deploy dedicated infrastructure for sensing and actuation, and there is a lack of a systematic way to go from sensor data to inference. My vision is that in future, given a sensing application and I tackle this challenge opportunistically. 
%From a sensing and estimation perspective, the challenge in 
%From a sensing and estimaiton perspective, there are two challenges in modern CPS. First, a large number of devices and new smart infrastructure deployed
%is in dealing with heterogeneity in sensing across a large number of devices and the lack of a systematic way to go from sensor data to inference
...
\paragraph{A Holistic Approach to Localization. } My holistic approach to localization spans embedded systems, sensing and estimation. It also spans working with industry 
 ...
 %I describe my work in theses three areas in context of indoor localization. %Finally, in applications where there is no localization infrastructure in place, we require 
%On one hand, we have systems with dedicated infrastructure that are high in cost and deliver 
