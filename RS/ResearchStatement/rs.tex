...
I enjoy working across a breadth of areas ranging from signal processing and estimation to system level design of sensing, communication and computing. I believe this puts me in the perfect place to tackle the challenges of building cost-effective, practical, efficeint and reliable CPS. I build systems that are practical and design information processing algorithms that are applicable to a broad class to systems. %I achieve this by understanding the physical layer 
...
\paragraph{Impact: }
My work has resulted in publications at IPSN, SenSys, RTAS, RTSS, ICCPS and VLCS. I have demonstrated my work in IPSN, SenSys and ICCPS. My work has been deployed in more than two dozen environments, received 2 patents, won the international
...
\paragraph{Dissertation Research}
...
Numerous localization solutions have emerged in the past decade, yet we get lost indoors today. Existing solutions are limited by trading-off performance and reliability for the cost associated with infrastructure deployed. My dissertation explores novel methods to leverage infrastructure in a smart manner to localize mobile devices.\\
...
%Multiple solutions exist. Trade-off between infrastructure and information. 

%In 2013, LED lights were phasing out incandescent lights. 
%I saw this as an opportunity to use them as a communication channel to send data to mobile devices. The main challenge is that the lights operate at a much higher frequency than the camera frame capture rate. 
My first insight to localize without deploying additional infrastructure was to reprogram overhead LED lights. %Lighting is a pervasive infrastructure inside buildings. 
I designed one of the earliest visible light communication (VLC) systems coarsely localizing phones with LED lights. %This was one of the earliest systems in LED-camera communication for localizing mobile phones 
...
I attended conference on positioning in museums. User security, privacy, who owns
I visited a security group physical layer attacks, how the problems affect the higher layers..\\
...
Manufacturing - depends on the resolution required.
