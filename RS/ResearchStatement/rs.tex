...
%My research lies at the intersection between theory and systems applied to modern Cyber-Physical System design.  
...
%Rather than waiting for a single technology to solve the problem, my work has looked at creating platforms for testing emerging technology with their associated run-time and configuration challenges.  % and address the core problems in estimation and system setup that other emerging localization technologies face. %that are finding their way in to commodity devices, and addressing the core problems in estimation and system setup.
