...
%The beacon coverage determines if a location can be uniquely localized. The accuracy however is hard to quantify. 
% to quantify the localization accuracy. 
  %I then introduced an indoor-GDOP metric that captured if a location was uniquely localizable and the included the Cramer-Rao bound. 
