...
\ifoot[Diversity Statement: Niranjini Rajagopal]{}
\cfoot[]{}
...
%Over the years I have come to understand the barriers that exist 
%I have been fortunate to have mentors who
%My appreciation for diversity has come from my own experiences of expanding my understanding of the world when I  
%Over the years I have experienced my growth when I interact with 

%I have come to recognize that there are several barriers resulting in unequal representtion of groups in our educational institutions. 
%Over the years I have experienced the value that a diverse environment provides, and also developed an un
%Over the years, I have developed an understanding of barriers that exist resulting in unequal representation of groups in our educational insitutions, and I have involved myself in several educational volunteering and outreach activites to d a better understanding of the barriers that result, as well as the challenges in overcoming them. %Whiel growing up in India, IAs a women in STEM, and with my background of growing up in India and moving to the US for graduate school
...
Growing up in India, %the earliest disparity in education that struck me I had the privilege of the best educational resources and support, but %with the privilege of having opportunities to the best education resources and support, I realized 
%and strong role models andsupportive to have access to the best of education, and to have   to have access to exceand being fortunate to have access to a disparity I saw that had an impact on me was that education was a divider rather than an equalizer. 
%uneuql access to education due to economic factors had
I saw wide disparities in quality and access to education as a result of social and economic factors. %While this is a complex problem, one of the steps I took was to 
I worked with several K-12 educational outreach programs starting in my undergraduate years, involving myself in activities ranging from raising funds, teaching, assisting in labs, leading programs, creating instructor manuals, and volunteering. %Through these avenues we introduced students to something new in a hands-on manner, with the goal of sparking an interest.  
%Through these roles, I learnt that while small
Through these roles, I learned to adapt my approach to the educational environment, resources available, and the students' backgrounds. %Interacting with the students made me realize that even small interventions can make a difference.
% but at the same time the real challenge is in sustaining outreach programs for long durations. As a faculty, I would 
...
%Diversity for the sake of diversity results in exclusion rather than inclusion. I have experienced this when I am asked to be part of a group just to reduce the gender disparity.  In order for diversity to flourish, we have to mindfully create inclusive and respectful environments. 
...
% as well as leverage technologies such as augmented reality and virtual reality programs. %I would take efforts to facilitate open conversations and and discussions where we  %I would actively create a diverse research group and an environemnt where  %equity through my outreach, and will  equity contribute use pedagogical strategies to advance equity and inclusion in the classroom. I would create a culture in my research group that is inclusive, open in communication and supports individual students values. 
 %In the long-term I am interested in    
...
%With our disciplinary diversity, we perspectives. I 
%As a faculty, I would continue to engage with interacting with my peers from various departments and observing several classroom teaching sessions, I  began to see several ways to make classes more inclusive. I will continue to take efforts towards evidence-based practice. For instance, when I gave a guest lecture, I had it observed and received feedback, and realized that I was asking questionslearned that I was Irrespective of the size of the class, I would   %While working with underrepresented minorities and female students in ECE, I have found that sometimes 
%On the other hand, I truly fulfilling experience for me has been my role as a  Graduate Teaching Fellow at the Eberly Center. When I started off at the center with a cohort of Graduate Teaching Fellows, I was reluctant and held back from taking up consulting tasks as a large part of our role was in communicating with students one-on-one and in writing, and being a non-naive English speaker, and having a different style of communication, . My mentors at the center has a long chat with me and emphasized that t 
 %at CMU, I work with a cohort of peers from several diverse departments at CMU. I experienced the value of the different perspectives we all bring to the discussions, due to our varied disciplinary background. 
%To truly support diversity, I will strive to create inclusive environments, where everyone is respected for their contributions
...
%I make a concerted effort to learn about students' backgrounds and interests. In large classes, I conduct ungraded quizzes on the first day of class to assess students prior knowledge, and address any gaps through extra classes and office hours. 
%In smaller classes and while mentoring students for research, I meet students one-on-one early on and understand their background, any specific goals, and their interests, and we discuss various options for moving ahead. 
%One of the challenges 
%While mentoring students, I make a concerted effort to get to know them through one-on-one informal and formal meetings. \textbf{learn about their students' background knowledge} through ungraded quizzes on the first day of class, and through one-on-one meetings. I address any gaps through extra classes and office hours. 
